...
public class adv_frag extends Fragment {

    public RecyclerView.Adapter recyclerViewAdapter;

    public List<listItem> listItems;
    private String[] abc = {"2Captain Marvel","Robin Hood","Jungle Book","Jurassic Park","Star Wars","Joker","The Hobbit","Star Trek","Peter Pan","King Kong"};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.adv_frag_layout, container, false);


        RecyclerView recyclerView = root.findViewById(R.id.recyclerView);
        setRecyclerView(recyclerView);
        return root;// = inflater.inflate(R.layout.adv_frag_layout,container,false);
    }
    ...
    public void setRecyclerView(RecyclerView recyclerView){
        ...
        for (int i = 0; i < 10; i++) {
            ...
            listItem listItem = new listItem(abc[i],xyz2[i]);
